...
import {variableListSlice} from "./_redux/variableListSlice.tsx";
...
interface VariableListMenuProps {

    variable: VariableModel;

}

export default function VariableListMenu({variable}: VariableListMenuProps) {
    ...
    const afterCloseDialog = (response: boolean) => {
        if (response) {
            dispatch(variableListSlice.actions.delete(variable.id));
            closeMenu();
        }
